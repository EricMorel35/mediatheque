...
public class Person implements Serializable {
	 ...
	 * @param job
	 */
	public void addCrew(final int id, final String name,
			final String profilePath, final String department, final String job) {
	 ...
	 * @param order
	 */
	public void addCast(final int id, final String name,
			final String profilePath, final String character, final int order) {
	...
	public void setAka(final List<String> aka) {
		this.aka = aka;
	}
	...
	public boolean equals(final Object obj) {
		...
		if ((this.profilePath == null) ? (other.profilePath != null)
	...
	public int hashCode() {
		...
		hash = 37 * hash
				+ (this.profilePath != null ? this.profilePath.hashCode() : 0);
		hash = 37 * hash
				+ (this.personType != null ? this.personType.hashCode() : 0);
		hash = 37 * hash
