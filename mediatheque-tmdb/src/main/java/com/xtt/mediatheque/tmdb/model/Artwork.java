...
public class Artwork implements Serializable {
	...
	public void setArtworkType(final ArtworkType artworkType) {
	...
	public boolean equals(final Object obj) {
		...
		if (Float.floatToIntBits(this.aspectRatio) != Float
				.floatToIntBits(other.aspectRatio)) {
			return false;
		}
		if ((this.filePath == null) ? (other.filePath != null) : !this.filePath
		...
		if ((this.language == null) ? (other.language != null) : !this.language
	...
	public int hashCode() {
		...
		hash = 71 * hash
				+ (this.artworkType != null ? this.artworkType.hashCode() : 0);
		return hash;
	}
